...
function CacheOp( $op, $priority = 0, $cbIsAborted = true )
{
	...
	if( ( $op == 0 || $op == 2 ) && (isset($settCache[ 'autoProc' ])?$settCache[ 'autoProc' ]:null) )
	{
...
function CacheOpGetViewsHeaders( $settCache, $viewId = null )
{
	...
	if( $viewId === null || $viewId === 'cmn' )
		$res[ 'cmn' ] = array( 'User-Agent' => 'Mozilla/99999.9 AppleWebKit/9999999.99 (KHTML, like Gecko) Chrome/999999.0.9999.99 Safari/9999999.99 seraph-accel-Agent/2.21.1' );
